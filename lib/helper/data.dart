...
import '../views/businesspage.dart';
...
List<CategorieModel> getCategories(){
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=in&category=business&apiKey=1bce48199bbb4cccb007c13c00140310';
  //categorieModel.categorieUrl=' https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=1bce48199bbb4cccb007c13c00140310';
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=us&category=entertainment&apiKey=1bce48199bbb4cccb007c13c00140310';
 ...
 //  categorieModel.categorieUrl='https://newsapi.org/v2/everything?domains=wsj.com&apiKey=1bce48199bbb4cccb007c13c00140310';
 // // categorieModel.categorieUrl=' https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=1bce48199bbb4cccb007c13c00140310';
 //
 //  myCategories.add(categorieModel);
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=1bce48199bbb4cccb007c13c00140310';
  myCategories.add(categorieModel);
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=1bce48199bbb4cccb007c13c00140310';
  myCategories.add(categorieModel);
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=in&category=sports&apiKey=1bce48199bbb4cccb007c13c00140310';
  myCategories.add(categorieModel);
  ...
  categorieModel.categorieUrl='https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=1bce48199bbb4cccb007c13c00140310';
  myCategories.add(categorieModel);
